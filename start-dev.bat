...
set "FRONTEND_DIR=%ROOT_DIR%imf-data-app"
...
start "IMF Backend" cmd /k "cd /d ""%BACKEND_DIR%"" && python -m uvicorn app.main:app --reload --port 8000"

echo Starting Next.js frontend...
start "IMF Frontend" cmd /k "cd /d ""%FRONTEND_DIR%"" && set NEXT_PUBLIC_API_BASE_URL=http://localhost:8000 && npm run dev"
